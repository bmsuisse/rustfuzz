...
impl BM25L {
    #[new]
    #[pyo3(signature = (corpus, k1=1.5, b=0.75, delta=0.5))]
    pub fn new(corpus: Vec<String>, k1: f64, b: f64, delta: f64) -> Self {
        let n = corpus.len() as f64;
        let tokenised: Vec<Vec<String>> = corpus.iter().map(|d| tokenise(d)).collect();
        ...
        BM25L { corpus, tokenised, idf, tf_norm, avgdl, k1, b, delta }
    }
...
impl BM25Plus {
    #[new]
    #[pyo3(signature = (corpus, k1=1.5, b=0.75, delta=1.0))]
    pub fn new(corpus: Vec<String>, k1: f64, b: f64, delta: f64) -> Self {
        let n = corpus.len() as f64;
        let tokenised: Vec<Vec<String>> = corpus.iter().map(|d| tokenise(d)).collect();
        ...
        BM25Plus { corpus, tokenised, idf, tf_norm, avgdl, k1, b, delta }
    }
...
impl BM25T {
    ...
    pub fn new(corpus: Vec<String>, k1: f64, b: f64) -> Self {
        ...
        BM25T { corpus, tokenised, idf, tf_norm, avgdl, k1, b }
    }
