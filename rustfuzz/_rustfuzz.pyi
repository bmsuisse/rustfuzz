...
# ---------------------------------------------------------------------------
# Search: BM25 (internal Rust types — use rustfuzz.search for the public API)
# ---------------------------------------------------------------------------
...
class BM25L:
    ...
    def __init__(
        self, corpus: list[str], k1: float = 1.5, b: float = 0.75, delta: float = 0.5
    ) -> None: ...
    @property
    def num_docs(self) -> int: ...
    def get_scores(self, query: str) -> list[float]: ...
...
class BM25Plus:
    ...
    def __init__(
        self, corpus: list[str], k1: float = 1.5, b: float = 0.75, delta: float = 1.0
    ) -> None: ...
    @property
    def num_docs(self) -> int: ...
    def get_scores(self, query: str) -> list[float]: ...
